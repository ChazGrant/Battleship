...
public:
    ...
    void setupUi(QWidget *LoginForm)
    {
        ...
        authenticate_tabWidget->setGeometry(QRect(0, 0, 221, 161));
        tab = new QWidget();
        ...
        loginPassword_lineEdit->setGeometry(QRect(50, 40, 113, 24));
        ...
        login_pushButton->setGeometry(QRect(50, 90, 111, 24));
        ...
        registrate_pushButton->setGeometry(QRect(40, 80, 131, 24));
        ...
        authenticate_tabWidget->setCurrentIndex(0);
