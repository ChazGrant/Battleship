...
enum INCOMING_ACTIONS_NAMES {
    ...
    GAME_STARTED, AVAILABLE_WEAPONS, GAME_OVER, OPPONENT_CONNECTED,
    // ChatSocket
...
const QMap<INCOMING_ACTIONS_NAMES, QString> INCOMING_ACTIONS = {
    ...
    {INCOMING_ACTIONS_NAMES::GAME_OVER, "game_over"},
    {INCOMING_ACTIONS_NAMES::OPPONENT_CONNECTED, "opponent_connected"},
    // ChatSocket
